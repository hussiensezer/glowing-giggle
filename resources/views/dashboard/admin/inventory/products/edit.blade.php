            ...
            <div class="tab-content" id="languages-contents">
                <div class="tab-pane fade show active" id="arabic-content" role="tabpanel" aria-labelledby="arabic-tab">
                    <form action="#" class="add-item-form arabic-add-item" name="arabic-add-product" id="arabic-add-product" method="GET">
                                    ...
                                    <div class="accordion-body card-body">
                                        ...
                                        <div class="mb-4 d-flex code-wrapper">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control field-edit hidden" name="code" id="code" placeholder="رمز المنتج">
                                        ...
                                        <div class="mb-4 description">
                                            ...
                                            <p class="field-show mb-0">وصف المنتج التجريبى</p>
                                        </div>
                                        <div class="d-flex align-items-center justify-content-end">
                                            <button type="button" class="btn col-3 field-show edit-btn">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <input type="text" class="form-control" name="supplier-code" id="supplier-code" title="رمز المنتج عند المورد" placeholder="رمز المنتج">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                        ...
                        <div class="accordion card processes section-show" id="processes">
                            <div class="accordion-item">
                                <h6 class="card-header accordion-header p-0" id="processes-header">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#processes-content" aria-expanded="true" aria-controls="processes-content">
                                        <ion-icon name="calculator-outline"></ion-icon>
                                        <span>العمليات</span>
                                        <ion-icon name="chevron-down-outline"></ion-icon>
                                    </button>
                                </h6>
                                <div id="processes-content" class="accordion-collapse collapse" aria-labelledby="processes-header" data-bs-parent="#processes">
                                    <div class="accordion-body card-body">
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <select class="form-select single-select" name="ingredient-main-item" id="ingredient-main-item">
                                                                    <option selected>المجموعة الرئيسية</option>
                                                                    <option value="1">ستائر</option>
                                                                    <option value="2">ستائر 2</option>
                                                                    <option value="3">ستائر 3</option>
                                                                </select>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <select class="form-select single-select" name="ingredient-sub-item" id="ingredient-sub-item">
                                                                    <option selected>المجموعة الفرعية</option>
                                                                    <option value="1">ستائر</option>
                                                                    <option value="2">ستائر 2</option>
                                                                    <option value="3">ستائر 3</option>
                                                                </select>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <select class="form-select single-select" name="ingredient-name" id="ingredient-name">
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <input type="number" class="form-control" name="ingredient-quantity" id="ingredient-quantity" placeholder="عدد">
                                                                <p class="mb-0 ms-1">حبة</p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <a href="javascript:;" class="delete fs-5" title="حذف المكون">
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <button type="button" class="btn btn-primary" title="إضافة مكون">
                                                                    <ion-icon name="add-outline"></ion-icon>
                                                                </button>
                                                            </div>
                                                        </td>
                                        ...
                                        <div class="justify-content-start mb-4 d-flex align-items-center manufact-procs">
                                            <label for="manufact-proc-1" class="form-label me-4">عمليات التصنيع:</label>
                                            <select class="form-select single-select me-4 field-edit hidden" name="manufact-proc-1" id="manufact-proc-1">
                                                <option>اختر العملية</option>
                                                <option value="1">القص</option>
                                                <option value="2">اللحام</option>
                                                <option value="3">التغليف</option>
                                            </select>
                                            <span class="field-show me-2">القص</span>
                                            <button type="button" class="btn btn-primary ms-4 field-edit hidden" title="إضافة عملية تصنيع">
                ...
                <div class="tab-pane fade" id="english-content" role="tabpanel" aria-labelledby="english-content">
                    <form action="#" class="add-item-form english-add-item" name="english-add-product" id="english-add-product" method="GET">
                                    ...
                                    <div class="accordion-body card-body">
                                        ...
                                        <div class="mb-4 d-flex code-wrapper">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control field-edit hidden" name="code-en" id="code-en" placeholder="Product code">
                                                <span class="field-show">0x40s4d</span>
                                            </div>
                                        </div>
                                        <div class="mb-4 d-flex align-items-center price">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <input type="text" class="form-control" name="supplier-code-en" id="supplier-code-en" title="Supplier's product code" placeholder="Product Code">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                        ...
                        <div class="accordion card processes section-show" id="processes-en">
                            <div class="accordion-item">
                                <h6 class="card-header accordion-header p-0" id="processes-header-en">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#processes-content-en" aria-expanded="true" aria-controls="processes-content-en">
                                        <ion-icon name="calculator-outline"></ion-icon>
                                        <span>العمليات</span>
                                        <ion-icon name="chevron-down-outline"></ion-icon>
                                    </button>
                                </h6>
                                <div id="processes-content-en" class="accordion-collapse collapse" aria-labelledby="processes-header-en" data-bs-parent="#processes-en">
                                    <div class="accordion-body card-body">
                                        <div class="mb-4 ingredients">
                                            <label class="form-label">المكونات</label>
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <select class="form-select single-select" name="ingredient-main-item-en" id="ingredient-main-item-en">
                                                                    <option selected>المجموعة الرئيسية</option>
                                                                    <option value="1">ستائر</option>
                                                                    <option value="2">ستائر 2</option>
                                                                    <option value="3">ستائر 3</option>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <select class="form-select single-select" name="ingredient-sub-item-en" id="ingredient-sub-item-en">
                                                                    <option selected>المجموعة الفرعية</option>
                                                                    <option value="1">ستائر</option>
                                                                    <option value="2">ستائر 2</option>
                                                                    <option value="3">ستائر 3</option>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <select class="form-select single-select" name="ingredient-name-en" id="ingredient-name-en">
                                                                    <option selected>المنتج</option>
                                                                    <option value="1">ستائر</option>
                                                                    <option value="2">ستائر 2</option>
                                                                    <option value="3">ستائر 3</option>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <input type="number" class="form-control" name="ingredient-quantity-en" id="ingredient-quantity-en" placeholder="Quantity">
                                                                <p class="mb-0 ms-1">حبة</p>
                                                            </div>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="justify-content-start mb-4 d-flex align-items-center manufact-procs">
                                            <label for="manufact-proc-1-en" class="form-label me-4">عمليات التصنيع:</label>
                                            <select class="form-select single-select me-4 field-edit hidden" name="manufact-proc-1-en" id="manufact-proc-1-en">
                                                <option>اختر العملية</option>
                                                <option value="1">القص</option>
                                                <option value="2">اللحام</option>
                                                <option value="3">التغليف</option>
