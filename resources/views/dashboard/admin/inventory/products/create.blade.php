            ...
            <div class="tab-content" id="languages-contents">
                <div class="tab-pane fade show active" id="arabic-content" role="tabpanel" aria-labelledby="arabic-tab">
                    <form action="#" class="add-item-form arabic-add-item" name="arabic-add-product" id="arabic-add-product" method="GET">
                                    ...
                                    <div class="accordion-body card-body">
                                        <div class="mb-4 d-flex main-sub-categories">
                                            <div class="input-group">
                                                ...
                                                <select class="form-select single-select" name="parent" id="parent">
                                        ...
                                        <div class="justify-content-start mb-4 d-flex align-items-center quantity">
                                            ...
                                            <input type="number" class="form-control me-2" name="quantity" id="quantity" placeholder="">
                                            <select class="form-select single-select ms-4" name="unit" id="unit">
                        ...
                        <div class="accordion card processes" id="processes">
                            <div class="accordion-item">
                                ...
                                <div id="processes-content" class="accordion-collapse collapse" aria-labelledby="processes-header" data-bs-parent="#processes">
                                    <div class="accordion-body card-body">
                                        ...
                                        <div class="justify-content-start mb-4 d-flex align-items-center manufact-procs">
                                            ...
                                            <select class="form-select single-select me-4" name="manufact-proc-1" id="manufact-proc-1">
                                                <option>اختر العملية</option>
                                                <option value="1">القص</option>
                                                <option value="2">اللحام</option>
                                                <option value="3">التغليف</option>
                                            </select>
                                            <button type="button" class="btn btn-primary ms-4" title="إضافة عملية تصنيع">
                                    ...
                                    <div class="accordion-body card-body">
                                        <div class="mb-4 d-flex main-sub-categories">
                                            <div class="input-group">
                                                ...
                                                <select class="form-select single-select" name="parent-en" id="parent-en">
                                        ...
                                        <div class="justify-content-start mb-4 d-flex align-items-center quantity">
                                            ...
                                            <select class="form-select single-select ms-4" name="unit-en" id="unit-en">
                                ...
                                <div id="additional-information-content" class="accordion-collapse collapse" aria-labelledby="additional-information-header" data-bs-parent="#additional-information">
                                    <div class="accordion-body card-body">
                                        <div class="justify-content-start mb-4 d-flex align-items-center min-quantity">
                                            ...
                                            <input type="number" min="1" class="form-control" name="min-quantity-en" id="min-quantity-en" placeholder="1">
                                            <p class="mb-0 ms-2">
                                                وحدة القياس
                                            </p>
                                        </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <input type="text" class="form-control" name="supplier-code-en" id="supplier-code-en" placeholder="Code">
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                ...
                                <div id="processes-content" class="accordion-collapse collapse" aria-labelledby="processes-header" data-bs-parent="#processes">
                                    <div class="accordion-body card-body">
                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <input type="number" class="form-control me-2" name="ingredient-quantity-en" id="ingredient-quantity-en" placeholder="Quantity">
                                                                <p class="mb-0 ms-1">حبة</p>
                                                            </div>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="justify-content-start mb-4 d-flex align-items-center manufact-procs">
                                            ...
                                            <select class="form-select single-select me-4" name="manufact-proc-1-en" id="manufact-proc-1-en">
                                                <option>Choose a Process</option>
                                                <option value="1">Cut</option>
                                                <option value="2">Welding</option>
                                                <option value="3">Encapsulation</option>
                                            </select>
                                            <button type="button" class="btn btn-primary ms-4" title="إضافة عملية تصنيع">
                                                <ion-icon name="add-outline" role="img" class="md hydrated" aria-label="add outline"></ion-icon>
                                            </button>
